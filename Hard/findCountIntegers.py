...
print(solution.countGoodIntegers(2, 3))

print(solution.countGoodIntegers(4, 2))

print(solution.countGoodIntegers(10, 9))

print(solution.countGoodIntegers(1, 1))

print(solution.countGoodIntegers(2, 1))
